"""
decoupled neural interfaces; code adapted from https://github.com/koz4k/dni-pytorch
"""
...
class BasicSynthesizer(torch.nn.Module):
    ...
    def __init__(self, output_dim, n_hidden=0, hidden_dim=None,
                 trigger_dim=None, context_dim=None, bias=True):
        super().__init__()
